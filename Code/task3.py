...
def table_load_dictionary_statistics(max_time):
    ...
    readFile = open('output_task3.csv', 'w')
...
if __name__ == "__main__":
    ...
    lines = [[27183, 402221, 0.5019998550, 'english_small.txt', 8850, 11277, 8, 0],
    [250726, 1000081, 0.4529969692, 'english_small.txt', 3552, 3882, 4, 0],
    [27183, 402221, 1.1020004749, 'english_large.txt', 47013, 91423, 24, 0],
    [250726, 1000081, 1.0630273819, 'english_large.txt', 18651, 23172, 7, 0],
    [27183, 402221, 1.3149828911, 'french.txt', 50850, 103017, 31, 0],
    [250726, 1000081, 1.2960014343, 'french.txt', 20393, 25581, 10, 0]]
    ...
    # data to plot
    n_groups = 2
    means_low = (lines[0][4], lines[1][4])
    means_mid = (lines[2][4], lines[3][4])
    means_high = (lines[4][4], lines[5][4])
